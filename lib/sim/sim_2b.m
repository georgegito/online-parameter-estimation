function sim_2b( r1, r2, theta_m, n0, f )
...
%% compute states by solving the differential equations of the system
    [ ~, x ] = ode45( @( t, x ) msd_2b( t, x, u, theta_m, r1, r2, a, b, n ), t_span, x0 );
...
%% plots 
    ...
    title('real, noisy \& estimated output (SP)',  'interpreter', 'latex', 'FontWeight', 'bold');
...
%     legend('$y$', '$\hat{y}$', 'interpreter', 'latex', 'FontWeight', 'bold');
    ...
    grid on;
    xlabel('time (s)', 'interpreter', 'latex', 'FontWeight', 'bold');
    title('estimated parameters (SP)', 'interpreter', 'latex', 'FontWeight', 'bold');
    ...
    grid on;
    xlabel('time (s)', 'interpreter', 'latex', 'FontWeight', 'bold');
    title('squared error (SP)', 'interpreter', 'latex', 'FontWeight', 'bold');
